  ...
  <main>
    <article>
      ...
      <section class="section service bg-black-10 text-center" aria-label="service">
        <div class="container">
          <p class="section-subtitle label-2">ВКУСЫ ДЛЯ КОРОЛЯ</p>
          <h2 class="headline-1 section-title">Мы предлагаем на высшем уровне</h2>
          ...
          <ul class="grid-list">
            <?php
            $sel_category = mysqli_query($link, "SELECT * FROM `category` ORDER BY `id` ASC");
            $sel_category = mysqli_fetch_all($sel_category);

            foreach($sel_category as $sc) { ?>
              <li>
                <div class="service-card">
                  <a href="./category.php?id=<?= $sc[0]; ?>" class="has-before hover:shine">
                    <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                      <img src="<?php print("./" . $sc[2]); ?>" width="285" height="336" loading="lazy" alt="Breakfast"
                        class="img-cover">
                    </figure>
                  </a>
                  <div class="card-content">
                    <h3 class="title-4 card-title">
                      <a href="./category.php?id=<?= $sc[0]; ?>"><?= $sc[1]; ?></a>
                    </h3>
                    <a href="./category.php?id=<?= $sc[0]; ?>" class="btn-text hover-underline label-2">Посмотреть меню</a>
                  </div>
                </div>
              </li>
            <?php }
      ...
      <!-- <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <h2 class="headline-1 section-title">Тортеллини с лобстером</h2>
            <p class="section-text">
              Lorem Ipsum is simply dummy text of the printingand typesetting industry lorem Ipsum has been the
      ...
      <section class="section menu" aria-label="menu-label" id="menu">
        <div class="container">
          ...
          <ul class="grid-list">
            <?php 
            $select_product = mysqli_query($link, "SELECT * FROM `product` ORDER BY `id` DESC LIMIT 6");
      ...
      <section class="reservation">
        <div class="container">
          <div class="form reservation-form bg-black-10">
            <form action="./reservat/reservat.php" class="form-left" method="post">
              ...
              <div class="input-wrapper">
                <div class="icon-wrapper">
                  ...
                  <select name="person-out" class="input-field">
